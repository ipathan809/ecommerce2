      ...
      <div className="pt-6">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-wrap space-x-5 justify-center">
           ...
           {/* Product info */}
        <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-7xl
          lg:px-8 lg:pb-4">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            {/* Reviews */}
            <div className="mt-6">
                <div className='flex items-cengter space-x-3'>
                <Rating name="read-only" value={4.5} readOnly />
                <p className='opacity-50 text-sm'>56542 Ratings</p>
                <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>3682 Reviews</p>
                </div>
            </div>
                ...
                <Grid container spacing={7}>
                    ...
                    <Grid item xs={5}>
                        ...
                        <div className='flex items-center space-x-3'>
                            ...
                            <p className='opacity-60'>57555 Ratings</p>
                        </div>
                        ...
                        <Box className='mt-5 space-y-3' >
                            ...
                            <Grid container  alignItems="center" gap={3}>
                                <Grid item xs={2}>
                                <span style={{ marginRight: '0.5em' }}>Very</span>
                                         <span>Good</span>
                                </Grid>
                                <Grid item xs={7}>
